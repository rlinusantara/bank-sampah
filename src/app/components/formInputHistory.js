...
import FormInputSampahHistory from "./formInpuSampahHistory";

const FormInputHistory = ({ nasabah = [], hargaSatuan = 0 }) => {
    ...
    <>
      <div className="flex justify-center">
        <div className="flex flex-col  bg-accent mx-2 p-2 xl:p-4 xl:w-[1000px] w-full rounded-xl">
          ...
          <FormInputSampahHistory nasabah={nasabah} hargaSatuan={hargaSatuan} />
        </div>
      </div>
    </>
  );
...
export default FormInputHistory;
